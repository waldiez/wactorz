...
Zero-LLM, zero-API-key built-in knowledge base about the AgentFlow system.
...
Commands:
  ...
  version                 AgentFlow version string
"""
...
_VERSION = "AgentFlow v0.1.0 — Python runtime"
...
_KB: dict[str, str] = {
    ...
    "api": (
        ...
        "- nginx is the single public entry point; agentflow binary listens on :8080 (REST) / :8081 (WS)"
    ),
    "chat": (
        "**Chat flow**\n\n"
    ...
    "rust": (
        ...
        "Crates: `agentflow-core`, `agentflow-agents`, `agentflow-mqtt`.\n"
