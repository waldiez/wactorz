...
export class UI {
    ...
    frame(f) {
        ...
        $("wx-dif-bar").style.width = `${Math.min(100, f.outdoor.dif / 5)}%`;
        $("wx-dir-bar").style.width = `${Math.min(100, f.outdoor.dir_sun / 9)}%`;
