 ...
 * avatar (DiceBear instant placeholder; Gemini photo swaps into the header
 * via the "agent-image-ready" event).
 *
...
export class ChatPanel {
  ...
  constructor() {
    ...
    // Swap header avatar when a Gemini image arrives for the active agent
    document.addEventListener("agent-image-ready", (e) => {
